...
public class Exercise2Test {
    ...
    public void localTimeWith() {
         ...
         */
        LocalTime localTime = lt.withHour(21);// lt.with(ChronoField.HOUR_OF_DAY, 21);
    ...
    public void localTimePlus() {
         ...
         */
        LocalTime localTime = lt.plusMinutes(30);// lt.plus(30,ChronoUnit.MINUTES);
    ...
    public void localTimeMinus() {
         ...
         */
        LocalTime localTime = lt.minusHours(3);// lt.minus(3, ChronoUnit.HOURS);
    ...
    public void localTimeMinusDuration() {
         ...
         */
        Duration duration = // Duration.parse("PT03H30M20.2S");
            // Duration.ofHours(3)
            // .ofMinutes(30)
            // .ofSeconds(20)
            // .ofNanos(200000000);
            Duration.ofSeconds(3 * 3600 + 30 * 60 + 20, 200 * 1000 * 1000);
    ...
    public void localDateIsBefore() {
         ...
         */
        boolean isBefore2307 = !lt2.isAfter(lt);// lt2.isBefore(lt);

...
public class Exercise3Test {
    ...
    public void localDateTimeOf() {
         ...
         */
        LocalDateTime localDateTime = LocalDateTime.of(LocalDate.of(2015, Month.JUNE, 20), LocalTime.of(23, 07, 30));
    ...
    public void localDatePlusMinus() {
        ...
        LocalDateTime localDateTime = ldt.plusMonths(10)
            .minusHours(5);
        // ldt.plus(10,ChronoUnit.MONTHS).minus(5,ChronoUnit.HOURS);

...
public class Exercise1Test {
    ...
    public void localDateOf() {
         ...
         */
        LocalDate localDate = LocalDate.of(2015, Month.JUNE, 18);// LocalDate.of(2015, 06, 18);
    ...
    public void localDateWithAdjuster() {
         ...
         */
        LocalDate localDate = // ld.withDayOfYear(1).plusYears(1);
            ld.with(TemporalAdjusters.firstDayOfNextYear());
    ...
    public void localDateIsAfter() {
         ...
         */
        boolean isAfter0618 = !ld2.isBefore(ld);// ld2.isAfter(ld);

...
public class Exercise2Test extends ClassicOnlineStore {
    ...
    public void descSortByAge() {
         ...
         */
        Comparator<Integer> descOrder = (n1, n2) -> n2 - n1;// Comparator.comparingInt(n -> -n);
        Stream<Integer> sortedAgeStream = customerList.stream()
            .map(Customer::getAge)
            .sorted(descOrder);
    ...
    public void top3RichCustomer() {
        ...
        Stream<String> top3RichCustomerStream = customerList.stream()
            // .sorted(Comparator.comparing(c -> -c.getBudget()))
    ...
    public void itemsCustomersWantToBuy() {
         ...
         */
        Function<Customer, Stream<Item>> getItemStream = c -> c.getWantToBuy()
            .stream();
        ...
        assertThat(itemList, contains("small table", "plate", "fork", "ice cream", "screwdriver", "cable", "earphone", "onion", "ice cream", "crisps", "chopsticks", "cable", "speaker", "headphone", "saw", "bond", "plane", "bag", "cold medicine", "chair",
            "desk", "pants", "coat", "cup", "plate", "fork", "spoon", "ointment", "poultice", "spinach", "ginseng", "onion"));
    }
}
